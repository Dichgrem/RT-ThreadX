...
/**
  ...
  */
/*
 * �?1）上电或复位后，系统进行初始化，初始化完成后进入正常运行状�??, LED1�?1s的改变亮度，亮度�?10级，从亮�?1逐渐变为亮度10，再从亮�?10变为亮度1，以此循环�??
 * �?2）按键K1通过轮询的方式控制LED2，每按一次K1，LED2状�?�发生一次改变�??
 * �?3）按键K2通过外部中断的方式控制LED2，每按一次K1，LED2状�?�发生一次改变�??
 * */
